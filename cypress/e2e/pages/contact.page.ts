class ContactPage {
  elements = {
    ...
    additionalInfoInput: () => cy.get("#Form_Additional_Information__c"),
    submitButton: () => cy.get("button[type='submit']"),

    helpSelectErrorMsg: () => cy.get("#ValidMsgReason_for_Contact__c"),
    ...
    additionalInfoErrorMsg: () =>
      cy.get("#ValidMsgForm_Additional_Information__c"),
  };
  ...
  fillAdditionalInfo(info: string) {
    this.elements.additionalInfoInput().type(info);
  }
